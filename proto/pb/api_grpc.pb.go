...
const (
	CoordinatorService_SubmitTask_FullMethodName       = "/dts.CoordinatorService/SubmitTask"
	CoordinatorService_SendHeartbeat_FullMethodName    = "/dts.CoordinatorService/SendHeartbeat"
...
type CoordinatorServiceClient interface {
	...
	SubmitTask(ctx context.Context, in *FinishedTaskRequest, opts ...grpc.CallOption) (*FinishedTaskResponse, error)
...
func (c *coordinatorServiceClient) SubmitTask(ctx context.Context, in *FinishedTaskRequest, opts ...grpc.CallOption) (*FinishedTaskResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FinishedTaskResponse)
...
type CoordinatorServiceServer interface {
	// Processes finished task submitted by the worker
	SubmitTask(context.Context, *FinishedTaskRequest) (*FinishedTaskResponse, error)
	// Processes heartbeat from the worker
...
func (UnimplementedCoordinatorServiceServer) SubmitTask(context.Context, *FinishedTaskRequest) (*FinishedTaskResponse, error) {
...
func _CoordinatorService_SubmitTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoordinatorServiceServer).SubmitTask(ctx, req.(*FinishedTaskRequest))
	}
...
const (
	WorkerService_ProcessTask_FullMethodName = "/dts.WorkerService/ProcessTask"
)
...
type WorkerServiceClient interface {
	...
	ProcessTask(ctx context.Context, in *NewTaskRequest, opts ...grpc.CallOption) (*NewTaskResponse, error)
}
...
func (c *workerServiceClient) ProcessTask(ctx context.Context, in *NewTaskRequest, opts ...grpc.CallOption) (*NewTaskResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type WorkerServiceServer interface {
	// Processes the recieved task
	ProcessTask(context.Context, *NewTaskRequest) (*NewTaskResponse, error)
...
func (UnimplementedWorkerServiceServer) ProcessTask(context.Context, *NewTaskRequest) (*NewTaskResponse, error) {
...
func _WorkerService_ProcessTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkerServiceServer).ProcessTask(ctx, req.(*NewTaskRequest))
	}
	return interceptor(ctx, in, info, handler)
}
